                    ...
                    >
                        ...
                        <div style={{
                            ...
                            >
                                ...
                                {/* Dummy Overlays */}
                                <motion.div style={{ position: 'absolute', inset: 0, background: 'rgba(0,229,255,0.05)', border: '4px solid var(--accent-cyan)', opacity: rightOpacity, borderRadius: '14px', pointerEvents: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 20, backdropFilter: 'blur(6px)' }}>
                                ...
                                <motion.div style={{ position: 'absolute', inset: 0, background: 'rgba(150,150,150,0.05)', border: '4px solid #888', opacity: leftOpacity, borderRadius: '14px', pointerEvents: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 20, backdropFilter: 'blur(6px)' }}>
                                ...
                                <motion.div style={{ position: 'absolute', inset: 0, background: 'rgba(255,83,112,0.05)', border: '4px solid var(--accent-red)', opacity: downOpacity, borderRadius: '14px', pointerEvents: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 20, backdropFilter: 'blur(6px)' }}>
                                ...
                                <motion.div style={{ position: 'absolute', inset: 0, background: 'rgba(0,230,118,0.05)', border: '4px solid #00e676', opacity: upOpacity, borderRadius: '14px', pointerEvents: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 20, backdropFilter: 'blur(6px)' }}>
