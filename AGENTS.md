...
This file provides context for any AI coding assistant working on this repository.
...
- Connection uses env vars: `AWS_DB_ENDPOINT`, `AWS_DB_NAME`, `AWS_DB_USERNAME`, `AWS_DB_PASSWORD`. See `.env.example` for the full template.
...
- See `README.md` for full API docs, project structure, design system, and deployment details.
